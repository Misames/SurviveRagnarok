...
public class HeroTrainingController : UnitController
{
    ...
    private float AttackFitnessCalc()
    {
        return enemiesDamaged * 10;
    }
    
    private float DefenseFitnessCalc()
    {
        return _gameManager.playerHealth * 10;
    }
    
    private float HealFitnessCalc()
    {
        return health * 10;
    }
    ...
    public override float GetFitness()
    {
        // Calculate fitness
        float fit = 0;
        if (currentState == State.Attack) fit = AttackFitnessCalc();
        else if (currentState == State.Defense) fit = DefenseFitnessCalc();
        else if (currentState == State.Heal) fit = HealFitnessCalc();
